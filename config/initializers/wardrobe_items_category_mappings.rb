WARDROBE_ITEMS_CATEGORIES = {
  ...
  # One-pieces like jumpsuits, rompers, overalls
  "one_pieces" => [
    "jumpsuit", "romper", "overalls", "leotard", "unitard"
  ],
  ...
  "sleepwear_loungewear" => [
    "pajamas", "robe", "nightgown", "loungewear", "sleep shorts", "onesie"
  ],
  ...
  # Costumes (optional, depends on your app’s focus)
  "costumes" => [
