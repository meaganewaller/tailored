...
class WardrobeItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should update wardrobe_item" do
    patch wardrobe_item_url(@wardrobe_item), params: {wardrobe_item: {account_id: @wardrobe_item.account_id, category: @wardrobe_item.category, color: @wardrobe_item.color, condition: @wardrobe_item.condition, cost: @wardrobe_item.cost, name: @wardrobe_item.name, occasion: @wardrobe_item.occasion, season: @wardrobe_item.season}}
